...
double calc_pi_double_for(long num_steps, double step) {
    double x, sum = 0.0;
...
double pi_omp_parallel_critical_errado (long num_steps) {
    ...
    // Print dos resultados
    std::cout << "-------------------------" << std::endl;
    std::cout << "pi_omp_parallel_critical_errado" << std::endl;
    std::cout << "O valor de pi calculado com " << num_steps << " passos levou ";
    std::cout << runtime.count() << " milisegundo(s) e chegou no valor : ";
    std::cout.precision(17);
    std::cout << pi << std::endl;
...
double pi_omp_parallel_for (long num_steps) {
    int num_threads = omp_get_max_threads(); // Numero total de threads
    double parallel_num_steps = (double) num_steps / (double) num_threads; // total de passos de cada thread
    double step = 1.0 / (double) num_steps;
    ...
    double pi = calc_pi_double_for(num_steps, step);
    ...
    // Print dos resultados
    std::cout << "-------------------------" << std::endl;
    std::cout << "pi_omp_parallel_for" << std::endl;
    std::cout << "O valor de pi calculado com " << num_steps << " passos levou ";
    std::cout << runtime.count() << " milisegundo(s) e chegou no valor : ";
    std::cout.precision(17);
    std::cout << pi << std::endl;
...
int main() {
    ...
    double pi_omp_for = pi_omp_parallel_for(num_steps);
}
